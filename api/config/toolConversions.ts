...
export interface ToolConversionConfig {
  ...
  suggestedOutputExtension: string;
  suggestedOutputMime: string;
}

/**
 * Map of all tool conversions
 */
export const toolConversions: Record<string, ToolConversionConfig> = {
  // PDF to Word
  'pdf-to-word': {
 ...
 */
export function getConversionConfig(toolSlug: string): ToolConversionConfig | undefined {
