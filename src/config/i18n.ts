...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'home.hero.description': 'Convert files instantly with our powerful, secure, and free online converter. Free forever, up to 500MB per file.',
    ...
    'upload.limit': 'Convert files up to 500MB. Free forever.',
    ...
    'faq.convert.answer': 'Simply drag and drop your file into the upload box, select your desired output format, and click convert. Your file will be processed and ready for download in seconds. Free forever, up to 500MB per file.',
    ...
    'faq.size.limit.answer': 'You can convert files up to 500MB per file. PDFStation is free forever for core conversions, with no signup required.',
    ...
    'tool.tips.tip3': 'Keep file sizes under 500MB for faster processing',
    ...
    'tool.faq.size.answer': 'You can convert files up to 500MB. PDFStation is free forever with no signup required.',
    ...
    'terms.service.text1': 'PDFStation provides a free online file conversion service. No signup, login, or account is required. We allow users to convert files between various formats, including PDF, Word, Excel, and image formats. Our service is free forever, supported by Google Ads, with a file size limit of 500MB per file.',
    ...
    'terms.limitations.text': 'Our service supports files up to 500MB in size. We support various file formats as listed on our website. We reserve the right to modify these limitations at any time.',
  ...
  'pt-BR': {
    ...
    'home.hero.description': 'Converta arquivos instantaneamente com nosso conversor online poderoso, seguro e gratuito. Grátis para sempre, até 500MB por arquivo.',
    ...
    'upload.limit': 'Converta arquivos de até 500MB. Grátis para sempre.',
    ...
    'faq.convert.answer': 'Simplesmente arraste e solte seu arquivo na caixa de upload, selecione o formato de saída desejado e clique em converter. Seu arquivo será processado e estará pronto para download em segundos. Grátis para sempre, até 500MB por arquivo.',
    ...
    'faq.size.limit.answer': 'Você pode converter arquivos de até 500MB por arquivo. O PDFStation é gratuito para sempre para conversões principais, sem necessidade de cadastro.',
    ...
    'tool.tips.tip3': 'Mantenha os tamanhos de arquivo abaixo de 500MB para processamento mais rápido',
    ...
    'tool.faq.size.answer': 'Você pode converter arquivos de até 500MB. O PDFStation é gratuito para sempre, sem necessidade de cadastro.',
    ...
    'terms.service.text1': 'O PDFStation fornece um serviço gratuito de conversão de arquivos online. Nenhum cadastro, login ou conta é necessário. Permitimos que os usuários convertam arquivos entre vários formatos, incluindo PDF, Word, Excel e formatos de imagem. Nosso serviço é gratuito para sempre, suportado pelo Google Ads, com um limite de tamanho de arquivo de 500MB por arquivo.',
    ...
    'terms.limitations.text': 'Nosso serviço suporta arquivos de até 500MB. Suportamos vários formatos de arquivo conforme listado em nosso site. Reservamo-nos o direito de modificar essas limitações a qualquer momento.',
  ...
  es: {
    ...
    'home.hero.description': 'Convierte archivos al instante con nuestro conversor online potente, seguro y gratuito. Gratis para siempre, hasta 500MB por archivo.',
    ...
    'upload.limit': 'Convierte archivos de hasta 500MB. Gratis para siempre.',
    ...
    'faq.convert.answer': 'Simplemente arrastra y suelta tu archivo en la caja de carga, selecciona el formato de salida deseado y haz clic en convertir. Tu archivo se procesará y estará listo para descargar en segundos. Gratis para siempre, hasta 500MB por archivo.',
    ...
    'faq.size.limit.answer': 'Puedes convertir archivos de hasta 500MB por archivo. PDFStation es gratuito para siempre para conversiones principales, sin necesidad de registro.',
    ...
    'tool.tips.tip3': 'Mantén los tamaños de archivo por debajo de 500MB para un procesamiento más rápido',
    ...
    'tool.faq.size.answer': 'Puedes convertir archivos de hasta 500MB. PDFStation es gratuito para siempre, sin necesidad de registro.',
    ...
    'terms.limitations.text': 'Nuestro servicio admite archivos de hasta 500MB. Admitimos varios formatos de archivo según se enumeran en nuestro sitio web. Nos reservamos el derecho de modificar estas limitaciones en cualquier momento.',
  ...
  fr: {
    ...
    'home.hero.description': 'Convertissez des fichiers instantanément avec notre convertisseur en ligne puissant, sécurisé et gratuit. Gratuit pour toujours, jusqu\'à 500MB par fichier.',
    ...
    'upload.limit': 'Convertissez des fichiers jusqu\'à 500MB. Gratuit pour toujours.',
    ...
    'faq.convert.answer': 'Glissez-déposez simplement votre fichier dans la zone de téléchargement, sélectionnez le format de sortie souhaité et cliquez sur convertir. Votre fichier sera traité et prêt à être téléchargé en quelques secondes. Gratuit pour toujours, jusqu\'à 500MB par fichier.',
    ...
    'faq.size.limit.answer': 'Vous pouvez convertir des fichiers jusqu\'à 500MB par fichier. PDFStation est gratuit pour toujours pour les conversions principales, aucune inscription requise.',
    ...
    'tool.tips.tip3': 'Gardez les tailles de fichier sous 500MB pour un traitement plus rapide',
    ...
    'tool.faq.size.answer': 'Vous pouvez convertir des fichiers jusqu\'à 500MB. PDFStation est gratuit pour toujours, aucune inscription requise.',
    ...
    'terms.limitations.text': 'Notre service prend en charge les fichiers jusqu\'à 500MB. Nous prenons en charge divers formats de fichiers comme indiqué sur notre site web. Nous nous réservons le droit de modifier ces limitations à tout moment.',
  ...
  it: {
    ...
    'home.hero.description': 'Converti file all\'istante con il nostro convertitore online potente, sicuro e gratuito. Gratuito per sempre, fino a 500MB per file.',
    ...
    'upload.limit': 'Converti file fino a 500MB. Gratuito per sempre.',
    ...
    'faq.convert.answer': 'Trascina e rilascia semplicemente il tuo file nella casella di caricamento, seleziona il formato di output desiderato e fai clic su converti. Il tuo file verrà elaborato e sarà pronto per il download in pochi secondi. Gratuito per sempre, fino a 500MB per file.',
    ...
    'faq.size.limit.answer': 'Puoi convertire file fino a 500MB per file. PDFStation è gratuito per sempre per le conversioni principali, nessuna registrazione richiesta.',
    ...
    'tool.tips.tip3': 'Mantieni le dimensioni dei file sotto 500MB per un elaborazione più veloce',
    ...
    'tool.faq.size.answer': 'Puoi convertire file fino a 500MB. PDFStation è gratuito per sempre, nessuna registrazione richiesta.',
    ...
    'terms.service.text1': 'PDFStation fornisce un servizio gratuito di conversione file online. Non è richiesta registrazione, accesso o account. Consentiamo agli utenti di convertire file tra vari formati, inclusi PDF, Word, Excel e formati immagine. Il nostro servizio è gratuito per sempre, supportato da Google Ads, con un limite di dimensione file di 500MB per file.',
    ...
    'terms.limitations.text': 'Il nostro servizio supporta file fino a 500MB. Supportiamo vari formati di file come elencato sul nostro sito web. Ci riserviamo il diritto di modificare queste limitazioni in qualsiasi momento.',
